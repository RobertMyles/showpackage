...
You can also see that a package I'm using, [splitstackshape](https://cran.r-project.org/web/packages/splitstackshape/index.html), relies on data.table. showpackage allows us to see how many of our installed packages depend on a certain package. Let's see how it is for [Rcpp](https://CRAN.R-project.org/package=Rcpp): 
